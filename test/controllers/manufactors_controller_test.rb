...
class ManufactorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manufactor" do
    assert_difference("Manufactor.count") do
      post manufactors_url, params: { manufactor: { manufactor: @manufactor.manufactor, manufactorId: @manufactor.manufactorId } }
    end
  ...
  test "should update manufactor" do
    patch manufactor_url(@manufactor), params: { manufactor: { manufactor: @manufactor.manufactor, manufactorId: @manufactor.manufactorId } }
