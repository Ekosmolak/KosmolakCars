...
class ManufacturersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manufacturer" do
    assert_difference("Manufacturer.count") do
      post manufacturers_url, params: { manufacturer: { manufacturer: @manufacturer.manufacturer } }
    end
  ...
  test "should update manufacturer" do
    patch manufacturer_url(@manufacturer), params: { manufacturer: { manufacturer: @manufacturer.manufacturer } }
